...
export const wishlist = pgTable(
  ...
  (t) => [
    index("wishlist_user_product_idx").on(t.userId, t.productId),
    index("wishlist_product_idx").on(t.userId),
  ]
);
...
export const cartItems = pgTable(
  ...
  (t) => [
    index("cart_items_user_product_idx").on(t.userId, t.productId),
...
export const productReviews = pgTable(
  ...
  (t) => [
    unique("product_reviews_user_product_unique").on(t.userId, t.productId),
    index("product_reviews_product_idx").on(t.productId),
    index("product_rating_idx").on(t.rating),
  ]
);
...
export const courierOrders = pgTable(
  ...
  (t) => [
    ...
    index("courier_orders_order_idx").on(t.orderId),
    index("courier_orders_status_idx").on(t.status),
  ]
);
...
export const productOfTheDay = pgTable(
  ...
  (t) => [unique("product_of_the_day_date_unique").on(t.date)]
);
